...
from core.constants import PATIENCE_FACTOR, WEIGHT_DECAY
from core.utils import distributed_context
from torch.optim import AdamW, Optimizer
from torch.optim.lr_scheduler import LambdaLR, LRScheduler

from core.model import Model, ModelId, ModelPaths
...
class DefaultTrainer(Trainer):
    ...
    def _initialise_optimiser(self, model: Model) -> Optimizer:
        return AdamW(
            model.parameters(), lr=self.model_id.task.learning_rate, weight_decay=WEIGHT_DECAY
        )
